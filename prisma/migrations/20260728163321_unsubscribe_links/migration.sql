...
CREATE TABLE "new_Sender" (
    ...
    "unsubscribeHttp" TEXT,
    "unsubscribeMailto" TEXT,
    "unsubscribeOneClick" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Sender" ("accountSlug", "category", "categoryReason", "categorySource", "displayName", "domain", "email", "firstMessageAt", "id", "kind", "lastMessageAt", "messageCount", "notes", "priority", "totalSizeBytes", "unseenCount", "unsubscribeCount", "updatedAt") SELECT "accountSlug", "category", "categoryReason", "categorySource", "displayName", "domain", "email", "firstMessageAt", "id", "kind", "lastMessageAt", "messageCount", "notes", "priority", "totalSizeBytes", "unseenCount", "unsubscribeCount", "updatedAt" FROM "Sender";
DROP TABLE "Sender";
