...
> Mesuré le 2026-08-11 à 14:17 · étiquettes gelées le 2026-08-11
>
> Ce fichier est produit par `npm run banc`. Il ne se modifie pas à la main.

## Le chiffre

**Taux de fuite : 60.2 %** (-1.6) — ❌ hors limite (< 1 %).

115 mails sur 191 dont l'oubli a une conséquence, et qui restent à traiter, n'apparaissent sur aucune surface du produit.
...
Sur tout le stock non résolu, sans limite d'âge : 1383 / 1459 (94.8 %). Ce chiffre situe l'arriéré ; il n'est pas le critère — reprocher au produit de ne pas afficher un mail de 2019 n'aurait pas de sens.

## Où les mails apparaissent

| Surface | Mails |
|---|---|
| réponses attendues | 158 |
| importants | 115 |
| aujourd'hui | 20 |
...
|---|---|---|---|
| Altoen | 4 | 2 | 50 % ⚠️ |
| Au-marais | 21 | 19 | 90.5 % ⚠️ |
| Brimmo | 63 | 42 | 66.7 % ⚠️ |
| Colocar | 22 | 10 | 45.5 % ⚠️ |
| Econom | 6 | 3 | 50 % ⚠️ |
| Location_Brest | 21 | 17 | 81 % ⚠️ |
| thony56_gtr | 54 | 22 | 40.7 % ⚠️ |
...
| Facture Sosh transmise par sa mère | visible | réponses attendues, aujourd'hui | ✅ |
